          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={CIRRMRI600Link}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2 bg-button" onClick={CIRRMRI600Link}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={CIRRMRI600Link}>
                  CIRRMRI600+
                </h2>
              </div>
            </div>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={PenSegDataLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={PenSegDataLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={GastroVisionLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-black text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  <p className="max-w-[90%] mx-auto text-justify leading-relaxed">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={GastroVisionLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={GastroVisionLink}>
                  Gastrovision
                </h2>
              </div>
            </div>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={PolypGenVideoSequenceLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={PolypGenVideoSequenceLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={PolypGenVideoSequenceLink}>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={PolypGenStillFramesLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-black text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={PolypGenStillFramesLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={PolypGenStillFramesLink}>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={CLEFmedLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={CLEFmedLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={CLEFmedLink}>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={KsvirSEGLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={KsvirSEGLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={KsvirSEGLink}>
                  Kvasir-SEG
                </h2>
              </div>
            </div>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={EndoCVLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={EndoCVLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={EndoCVLink}>
                  Endocv 2021
                </h2>
              </div>
            </div>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={KvasirInstrumentLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={KvasirInstrumentLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={KvasirInstrumentLink}>
                  Kvasir-Instrument
                </h2>
              </div>
            </div>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={KvasirsessileLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={KvasirsessileLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={KvasirsessileLink}>
                  Kvasir-sessile
                </h2>
              </div>
            </div>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={EndoTact2021}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={EndoTact2021}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={EndoTact2021}>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={MedicopolypoLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-white text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={MedicopolypoLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={MedicopolypoLink}>
            ...
            <div className="aspect-[2/2] rounded-lg shadow-md p-4 flex flex-col hover:cursor-pointer hover:scale-105 duration-300 group relative overflow-hidden" onClick={KvasircapsuleLink}>
              <div className="h-[80%] overflow-hidden rounded-lg mb-2 relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-sm bg-blue-400/30 text-black text-sm p-4 opacity-0 group-hover:opacity-100 transition duration-300 rounded-lg overflow-y-auto text-center">
                  ...
                  <button className="mt-2 bg-button text-white font-semibold rounded-2xl cursor-pointer hover:scale-105 duration-300 px-2.5 py-2" onClick={KvasircapsuleLink}>Get this DataSet</button>
                </div>
              </div>
              <div className="h-[20%] flex items-center justify-center text-center">
                <h2 className="text-lg font-bold group-hover:text-blue-500 duration-300 cursor-pointer" onClick={KvasircapsuleLink}>
                  Kvasir-capsule
                </h2>
              </div>
            </div>
